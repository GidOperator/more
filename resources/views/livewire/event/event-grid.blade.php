<div x-data="{ loading: false }"
    ...
    <div class="sorting-bar">
        <div class="select-sort-wrap">
            <span class="select-icon icon-less"></span>
            ...
            <span class="select-icon icon-chevrondown"></span>
        </div>
        <div class="listing-switch-group">
            ...
            <button type="button" class="listing-switch-btn">
                <span class="sort-icon icon-geo"></span>
            </button>
        </div>
    </div>
        ...
        <div class="events-col">
            <div class="event-card">
                <div class="event-card__top-btns">
                    ...
                    <a href="#" role="button"><span class="icon-bookmark"></span></a>
                ...
                <div class="event-card__carousel position-relative" style="height:180px; overflow:hidden;"
                    ...
                    <div class="slider-buttons">
                        <template x-if="images.length > 1">
                            <button @click.stop="prev" class="slider-arrow --prev">
                                <span class="icon-chevron-lft"></span>
                            </button>
                        </template>
                        <template x-if="images.length > 1">
                            <button @click.stop="next" class="slider-arrow --nex">
                                <span class="icon-chevron-rght"></span>
                            </button>
                        </template>
                    </div>
                    ...
                    <template x-if="images.length > 1">
                        <div class="slider-dots-wrap">
                            <template x-for="(img, i) in images" :key="i">
                                <button @click.stop="index = i" class="slider-dot" :class="index === i ? 'active' : 'not-active'"></button>
                            </template>
                        </div>
                    </template>
                ...
                <div class=" event-card__body d-flex flex-column">
                    ...
                    <div class="event-card__footer">
                        ...
                        <div class="event-card__price">
                            <span class="old-price">20 000 ₽</span><span>{{ number_format($event->price, 0, '.', ' ') }}</span> ₽
                        </div>
