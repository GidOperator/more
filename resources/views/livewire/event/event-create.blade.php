<div class="container create-event" x-data="eventForm()" x-cloak>

    <div class="create-event__header">
        <a href="/cabinet/organizer" class="back-btn"><span class="icon-chevron-lft"></span></a>
        <h1 class="create-event__heading">Новое событие</h1>
    </div>

    <form wire:submit.prevent="save">

        <div class="create-event__form-wrap">
            <div class="create-event__add-name">
                <label class="form-label --strong">Укажите название события</label>
                <input type="text" class="form-control" wire:model.defer="title">
                @error('title')
                <div class="error-massage">{{ $message }}</div>
                @enderror
            </div>
            <div class="create-event__categories" wire:ignore x-data="categoryDropdown(@entangle('subcategory_id'), {{ json_encode($categories) }})" @click.away="close()">
                <label class="form-label --strong">Выберите категорию / направление</label>
                <!-- Trigger -->
                <div class="form-control create-event__category-select"
            ...
            <div class="create-event__date-wrap">
                <div class="create-event__date-box">
                    <label class="form-label --strong">Дата / время начала</label>
                ...
                <div class="create-event__date-box">
                    <label class="form-label --strong">Дата / время окончания</label>
            ...
            <div class="mb-3">
                <label class="form-label --strong">Описание</label>
            ...
            <div class="row mb-3" x-data="{
                ...
                <div class="col-md-6 mb-3">
                    <label class="form-label --strong">Стоимость</label>
                ...
                <div class="col-md-6 mb-3">
                    <label class="form-label --strong d-block">Скидка</label>
            ...
            <div class="mb-3" x-data="{ count: @entangle('max_participants') }">
                <label class="form-label --strong">Максимальное количество участников</label>
            ...
            <div class="mb-3">
                <label class="form-label --strong">Город</label>
                @livewire('city.city-select', key('city-select'))
            </div>
            <div class="mb-3">
                <label class="form-label --strong">Адрес</label>
            ...
            <div class="mb-3">
                <label class="form-label --strong">Фото и видео</label>
            ...
            <div class="mb-3" x-data="videoForm()" x-cloak>
                <label class="form-label --strong">Ссылки на видео (YouTube/Vimeo)</label>
            ...
            <div class="mb-3" x-data="{ receiveOffers: @entangle('receive_offers') }">
                ...
                <div class="mt-3 border rounded p-3 bg-light" x-show="receiveOffers" x-transition>
                    <label class="form-label --strong">Какие категории партнёров вам интересны?</label>
