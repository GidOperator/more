            ...
            @foreach ($organizers as $organizer)
                <div class="organizers-card">
                    <div class="organizers-card__avatar">
                        <img src="{{ $organizer->avatar ?? '/img/avatar.png' }}" class="organizers-card__avatar-image"
                            alt="">
                    </div>
